  ...
  return (
    <div className="space-y-4">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 text-sm leading-6 text-muted-foreground">
              NOW turns nearby activity into warm signals, clear choices, and a
              fast path to meeting safely in public.
            </p>
          </div>
          <div className="flex items-center gap-2 rounded-full border bg-background px-3 py-2 text-xs text-muted-foreground">
            <span className="h-2.5 w-2.5 animate-pulse rounded-full bg-chart-1 shadow-[0_0_16px_hsl(var(--chart-1))]" />
            Live nearby
          </div>
        </div>
      </section>
      ...
      <section className="grid gap-4 rounded-xl border bg-card p-5 text-card-foreground lg:grid-cols-2">
        <div>
          <h2 className="font-semibold">Product rules</h2>
          <p className="mt-1 text-sm text-muted-foreground">
            The system keeps every screen focused, useful, and easy to scan.
          </p>
          <div className="mt-4">
            <Guidelines
              items={[
                { kind: 'do', text: 'Give each screen one primary action.' },
                { kind: 'do', text: 'Use large touch targets and three hierarchy levels or fewer.' },
                { kind: 'do', text: 'Show activity as anonymous lights, not profiles.' },
                { kind: 'dont', text: 'Do not use the electric blue accent as decoration.' },
                { kind: 'dont', text: 'Do not introduce dating, one-to-one, or payment patterns.' },
              ]}
            />
          </div>
        </div>
        <div>
          <h2 className="font-semibold">Motion language</h2>
          <p className="mt-1 text-sm text-muted-foreground">
            Motion should communicate live activity without slowing the path to action.
          </p>
          <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
            {[
              ...
              ['220ms', 'state change'],
              ['350ms', 'sheet / card'],
              ['500ms', 'hero / celebration'],
            ].map(([duration, label]) => (
              <div key={duration} className="rounded-lg border bg-background p-3">
                <p className="font-mono text-primary">{duration}</p>
