# Consuming NOW Design System in Expo apps

Read `artifacts/now-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/now-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/now-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/now-design-system/lib/native-theme";
import { useColors } from "@workspace/now-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/now-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/now-design-system/components/native/badge";
import { Button } from "@workspace/now-design-system/components/native/button";
import { Card } from "@workspace/now-design-system/components/native/card";
```
...
Import and render
`@workspace/now-design-system/components/native/button`, then run Expo
