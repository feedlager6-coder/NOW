# Migrating web UI to NOW Design System

Read `artifacts/now-design-system/docs/AGENTS.md` and
`artifacts/now-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/now-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/now-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/now-design-system/hooks/use-toast`
